...
static class CUBICWORLD_API ChunkUtil
{
public:
	...
	static FVector ConvertOffsetToChunkLocation(FIntVector Offset, FIntVector ChunkSize, int32 VoxelSize);
	static FVector ConvertVoxelOffsetToGlobalVoxelLocation(FIntVector VoxelOffset, FVector ChunkLocation, int32 VoxelSize);
